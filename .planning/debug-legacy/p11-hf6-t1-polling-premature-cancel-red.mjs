...
const hasSeenOnceRetentionGuard =
...
const output = {
  ...
  checks: [
    ...
    },
    {
      ...
      expected: false,
      pass: !hasSeenOnceRetentionGuard,
    },
    {
    ...
    {
      id: "current-runtime-guard-presence",
      expected: true,
      pass: hasSeenOnceRetentionGuard,
    },
  ],
...
console.log("FAIL - RED baseline preserved for HF6 closure evidence");
