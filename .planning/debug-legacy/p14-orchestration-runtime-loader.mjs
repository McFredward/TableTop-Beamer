...
function makeStub(name = "stub") {
  ...
  return new Proxy(target, {
    ...
    apply(t, thisArg, args) {
      // `video.play()` must return a real Promise so the mp4 prewarm
      // pipeline can await it during initializeApplication.
...
windowStub.location = { href: "http://localhost:8787/", hostname: "localhost", protocol: "http:", port: "8787", search: "", pathname: "/" };
