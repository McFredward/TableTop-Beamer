...
- [x] DONE P1-T121 [P0] Pflichtabnahme + Regression fuer Plan-Update 19 dokumentieren (kein Diagnose-Button sichtbar, Diagnose ueber Save weiterhin nutzbar, neutrales Export-Wording konsistent).
