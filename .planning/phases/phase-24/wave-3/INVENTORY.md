...
| W3.1-C4 | (pending) | W3.1 | `runtime-slider-touch-guard.js:94`, `runtime-polygon-drag-support.js:216`, `polygon-contract.js:7` | same files (call-site replacement) | 3 sites (3× `clamp01`) | yes (3 files clean) | n/a (expression-level replacement) | yes (utils at :826, polygon-contract :827, polygon-drag :829, slider-touch-guard :845) | polygon-drag cluster — pre-edit grep matched PLAN exactly |
