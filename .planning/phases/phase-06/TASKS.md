...
- [ ] TODO P6-T2 [P0] Server-Storage und Import-Validator implementieren (Importformat pruefen, persistieren, sichere Dateipfade, klare Fehlercodes).
- [ ] TODO P6-T3 [P0] Board-Import-Endpunkt + Katalog-Refresh integrieren, damit importierte Boards ohne manuellen Neustart sichtbar sind.
