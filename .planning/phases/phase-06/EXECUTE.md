...
## Priority Execution - Plan 6-3 (verbindlich, nach 6-HF3)
...
- Kein Weitergehen zu P6-T14+, bevor P6-T38 die Plan-6-HF3-Regression inkl. Artefakt-Sync abgeschlossen hat.
...
## Execution Update - 6-HF3 Complete
- P6-T35 DONE: Selection-Source-of-Truth stabilisiert (`visuell selektiert = aktiv selektiert`).
- P6-T36 DONE: Delete-Hotkey auf persistente aktive Selection entkoppelt (kein Hold-/Drag-Zwang).
- P6-T37 DONE: kombinierte Pflichtmatrix dokumentiert in `.planning/phases/phase-06/P6-T37-REGRESSION.md`.
- P6-T38 DONE: Artefakt-Sync fuer Phase-06 und globale Tracking-Dateien abgeschlossen; Gate zu Plan 6-3 ist offen.
