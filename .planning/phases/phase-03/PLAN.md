# Phase 3 Plan (Rework 3-3 Executed)

## Zielbild
Phase 3 Rework 3-3 haelt das separate Trigger-Modell aus 3-2 stabil und schliesst den P0-Defekt bei GIF-Raumanimationen: `kaputt`, `feuer` und `schleim` muessen als echte GIF-Loops aus den Assets laufen (native Framefolge), nicht als pseudoanimiertes Pulsieren/Zoom.
...
## Definition of Done
- Stories und Tasks aus `BACKLOG.md` und `TASKS.md` fuer Plan 3-2 sind abgeschlossen; Plan 3-3 ist vollstaendig umgesetzt.
