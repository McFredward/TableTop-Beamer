# Phase 9 Backlog (Replanned after binding `/output/final` architecture pivot)
...
- New user clarification is binding and introduces Plan 9-HF8 as immediate P0 blocker wave.
...
## Prioritized Execution Wave (P0) - Plan 9-HF8 execute-ready
- Story P9-HF8-S1 + P9-HF8-S2.
  - Goal: hard architecture pivot to true server video stream + pure receiver-only final client.
- Story P9-HF8-S3 + P9-HF8-S4 + P9-HF8-S5.
  - Goal: always-on authoritative compositor with fresh full-state compose and immediate mutation visibility.
- Story P9-HF8-S6 + P9-HF8-S7.
  - Goal: preserve control determinism while keeping HF5/HF6 contracts PASS.
- Story P9-HF8-S8.
  - Goal: parity/acceptance closure and full artifact synchronization.

## Follow-up Waves
- Plan 9-2 (after HF8 PASS): adapter cleanup, dependency hardening, optional diagnostics refinements.
...
- Plan 9-HF8 is completed PASS (server-video authority + receiver-only final page + parity evidence).
- Plan 9-2 is unblocked after HF8 PASS.
