...
- [ ] TODO P10-HF9-T2 [P0] Create deterministic RED repro for `stop` timeout under load and verify immediate-apply expectation fails pre-fix.
- [ ] TODO P10-HF9-T3 [P0] Create deterministic RED repro for ack-path instability (missing/late ack causing false timeout or duplicate resend side effects).
