...
- Current Phase: — (49 closed 2026-05-19; v1.0 release ready)
- Current Phase Key: (none — release window)
- Last Prepared: 2026-05-19
- Execution Readiness: RELEASE READY (Phase 49 closed; operator green-lit first release)
- Previous Phase: 49 (CLOSED — 2026-05-19, Release-Prep Small-Fixes Sammelphase: original Windows hardening (49-A Ctrl+C in existing shell + 49-B Job-Object close kill) plus 28 operator-UAT-driven gap-closures spanning align-mode SSR desync, dashboard 8 Hz CPU drain, mobile drag-reorder (touch-action evaluation timing → Sortable.js pattern), mobile portrait viewport zoom + cluster-rail clipping, animation-editor dirty-bar UX (auto-focus skip on touch, sticky-hover gate, bar shrink-wrap, Discard async-feedback race), board-switch profile fallback, 'Import from other board' feature, undo-to-baseline dirty-flag handling, polygon-edit SSR propagation, Win32 dashboard white-page + verdict-line crash. Operator confirmed end-to-end Android + Linux behavior, "Einem ersten release steht nichts mehr im Wege".)
- Older Phase: 46 (CLOSED — v1.0.0 release prep: version bump, README modernization, mobile light-mode fix, gitignore audit, tag phase-46-closed, 2026-05-16)
