...
(() => {
  ...
  // Stop-pipeline namespace ref. Captured at IIFE-top (defer-script
  // ordering ensures stop-pipeline's IIFE has run before this one).
  ...
  // Stop-pipeline functions moved to runtime-lifecycle-stop-pipeline.js
  // (W3.4-C2). Bare-name references in renderRunningAnimationsList /
  // dispatchClusterToggle / dispatchClusterClear resolve to IIFE-local
  // shadows reassigned in init.
