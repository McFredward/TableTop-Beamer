...
(() => {
  ...
  function _initMeshWarpGL() {
    ...
    try {
      ...
      // renderer no longer runs on the Pi at all. The mesh-warp GL pipeline
      ...
      // longer applies. Re-enabling MSAA softens any sub-pixel discontinuities
      // that survive the Phase 39.1 G2b 1-px vertex dilation (below) —
      // orthogonal layer of defence against H.264 encoder amplification of
      // mesh-shared-edge ridges.
      //
